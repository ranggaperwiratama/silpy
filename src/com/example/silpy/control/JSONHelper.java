...
package com.example.silpy.control;
...
public class JSONHelper
{
	...
	private final String	TAG_PerguruanTinggi	= "response";
	private final String	TAG_ID			= "id";
	private final String	TAG_NAMA		= "nama_pt";
	...
	public ArrayList<PerguruanTinggi> getPerguruanTinggiAll(JSONObject jobj)
	{
		ArrayList<PerguruanTinggi> listPerguruanTinggi = new ArrayList<PerguruanTinggi>();

		try
		{
			JSONArray arrayPerguruanTinggi = jobj.getJSONArray(TAG_PerguruanTinggi);

			for (int i = 0; i < arrayPerguruanTinggi.length(); i++)
			{
				JSONObject jobject = arrayPerguruanTinggi.getJSONObject(i);

				Log.d("log", "muter ke " + i);
//				listPerguruanTinggi.add(new PerguruanTinggi(jobject.getInt(TAG_ID), jobject.getString(TAG_NAMA), jobject
